      ...
      <div class="dashboard_graph">
        ...
        <div class="clearfix"></div>
          <div class="jumbotron" text-align="justify">
            <h2><i class="glyphicon glyphicon-folder-open"></i> Dashboard</h2>
              ...
              In case of problems, you can always make more changes to the database directly on <a href="https://pma.univ-lyon1.fr/" target="_blank">PHPMyAdmin</a>. The update of the data can be done directly from this page administrator. For more changes to the database structure, you will need to go to PHPMyAdmin.
              <br /><br /> </div>
